                  ...
                  {ttsOptions.map((option, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`absolute top-1/2 left-1/2 w-20 h-20 md:w-24 md:h-24 rounded-2xl flex flex-col items-center justify-center gap-1 transition-all duration-500 cursor-pointer border-2 ${
                          isSelected
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {ttsOptions.map((option, index) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <div
                      className={`w-10 h-10 rounded-lg flex items-center justify-center transition-colors ${
                        selectedSource === index ? "bg-primary/10" : "bg-secondary"
                      }`}
                    >
                      <option.Icon
                  ...
                  <div
                    className={`text-xs text-left mt-1 transition-opacity ${
                      selectedSource === index
