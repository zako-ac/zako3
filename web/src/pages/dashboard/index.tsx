                        ...
                        {isTapsLoading ? (
                            ...
                            <div className="space-y-2">
                                {myTaps.map((tap) => (
                                    <Link
                                        key={tap.id}
                                        to={ROUTES.TAP_STATS(tap.id)}
                                        className="flex items-center justify-between rounded-lg border p-4 gap-2 hover:border-accent transition-colors"
                                    >
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            {t('dashboard.uses', { count: tap.totalUses })}
                                        </p>
                                    </Link>
                                ))}
