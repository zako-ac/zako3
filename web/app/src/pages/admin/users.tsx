    ...
    return (
        <div className="space-y-6">
            ...
            <ConfirmDialog
                ...
                description={t('admin.users.banConfirm.description', { username: selectedUser?.username })}
            ...
            <ConfirmDialog
                ...
                description={t('admin.users.unbanConfirm.description', { username: selectedUser?.username })}
