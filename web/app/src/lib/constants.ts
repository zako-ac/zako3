...
export const ROUTES = {
  ...
  ADMIN_USER_SETTINGS: (userId: string) => `/admin/users/${userId}/settings`,
  ADMIN_USER_SETTINGS_USER: (userId: string) => `/admin/users/${userId}/settings/user`,
  ADMIN_USER_SETTINGS_GUILD_USER: (userId: string) => `/admin/users/${userId}/settings/guild-user`,
